...
public class TripController {
    ...
    public Map<String, Object> history(@RequestParam(defaultValue = "8") int limit) {
        PageResult<Map<String, Object>> history = tripHistoryPersistenceService.history(limit);
    ...
    public TripPlanResponse detail(@PathVariable long id) {
        ...
        return tripPlanPersistenceService.detail(id);
    }

    @PostMapping("/{id}/copy")
    public Map<String, Object> copy(@PathVariable long id, @RequestParam(defaultValue = "1001") long userId) {
    ...
    public Map<String, Object> delete(@PathVariable long id) {
        tripPlanPersistenceService.delete(id);
