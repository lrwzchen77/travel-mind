...
public class ResourceCrudController {
    ...
    private static final Set<String> ADMIN_RESOURCES = Set.of(
        "users", "user-preferences", "cities", "attractions", "hotels", "restaurants",
        "map-pois", "travel-tags", "travel-notes", "trip-plans", "ai-records"
    );
    ...
    public R<PageResult<Map<String, Object>>> list(
        ...
        requireAdminResource(resourceKey);
    ...
    private void requireAdminResource(String resourceKey) {
        if (!ADMIN_RESOURCES.contains(resourceKey)) {
