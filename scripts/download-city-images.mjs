...
const cities = [
  ...
  ['厦门', 'xiamen', 'Xiamen skyline China'],
  ['南昌', 'nanchang', 'Nanchang skyline China'],
  ['济南', 'jinan', 'Jinan city China'],
  ['青岛', 'qingdao', 'Qingdao skyline China'],
  ['桂林', 'guilin', 'Guilin landscape China'],
  ...
  ['大理', 'dali', 'Dali Yunnan landscape China'],
  ['丽江', 'lijiang', 'Lijiang old town China'],
